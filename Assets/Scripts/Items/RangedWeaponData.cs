...
public class RangedWeaponData
{
    ...
    [Tooltip("Force applied to fired projectiles (higher = faster bullets)")]
    ...
    [Tooltip("Default starting ammo when weapon is first acquired")]
    public int defaultStartingAmmo = 0;
    ...
    public Vector3 projectileSpawnRotation;

    [Header("Audio")]
    public AudioClip[] shootSounds;
    public AudioClip[] reloadStartSounds;
    public AudioClip[] reloadEndSounds;
