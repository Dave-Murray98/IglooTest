...
public enum ItemType
{
    ...
    OxygenTank,  // Works with the player oxygen system
    ToolEnergySource // Special case for tool's that require energy sources (ie blowtorch needs fuel)
}
...
public class ItemData : ScriptableObject
{
    ...
    [Tooltip("Scale override to apply to the equipped item")]
    public Vector3 equippedScaleOverride = new Vector3(1f, 1f, 1f);
    ...
    [Header("Melee Hurt Box Config")]
    public bool useLeftHandHurtBox = true;
    public bool usesMeleePositionOffset = false;
    public Vector3 meleeHurtBoxPositionOffset = Vector3.zero;
    ...
    [SerializeField] private OxygenTankData oxygenTankData;

    [Header("Tool Energy Source Settings")]
    [SerializeField] private ToolEnergySourceData toolEnergySourceData;
    ...
    public OxygenTankData OxygenTankData => oxygenTankData;
    public ToolEnergySourceData ToolEnergySourceData => toolEnergySourceData;
    ...
    {
        return GameManager.Instance.uiManager.inventoryItemVisualCellColorHelper.GetCellColor(itemType);
    }
