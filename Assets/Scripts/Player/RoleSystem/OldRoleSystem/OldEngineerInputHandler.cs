...
/// </summary>
public class OldEngineerInputHandler : MonoBehaviour
{
    [Header("Debug")]
    ...
    private void Awake()
    {
        ...
        if (playerInput == null)
        {
            Debug.LogError("[OldEngineerInputHandler] No PlayerInput component found!");
            return;
        }
    ...
    private void SetupInputActions()
    {
        ...
        if (engineerMap == null)
        {
            Debug.LogError("[OldEngineerInputHandler] Engineer action map not found!");
            return;
        }
    ...
    {
        if (enableDebugLogs)
            Debug.Log($"[OldEngineerInputHandler P{PlayerIndex}] {message}");
    }
