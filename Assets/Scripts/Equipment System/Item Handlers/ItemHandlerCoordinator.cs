...
public class ItemHandlerCoordinator : MonoBehaviour
{
    ...
    public UnarmedHandler unarmedHandler;
    public RangedWeaponHandler rangedWeaponHandler;
    public ConsumableHandler consumableHandler;
    public MeleeWeaponHandler meleeWeaponHandler;
    public KeyItemHandler keyItemHandler;
    ...
    private void OnItemEquipped(EquippedItemData equippedData)
    {
        ...
        {
            AudioManager.Instance.PlaySound2D(equipSounds[Random.Range(0, equipSounds.Length)], AudioCategory.PlayerSFX);
        }
