...
/// </summary>
public class OldPilotInputHandler : MonoBehaviour
{
    [Header("Debug")]
    ...
    private void Awake()
    {
        ...
        if (playerInput == null)
        {
            Debug.LogError("[OldPilotInputHandler] No PlayerInput component found!");
            return;
        }
    ...
    private void SetupInputActions()
    {
        ...
        if (pilotMap == null)
        {
            Debug.LogError("[OldPilotInputHandler] Pilot action map not found!");
            return;
        }
    ...
    {
        if (enableDebugLogs)
            Debug.Log($"[OldPilotInputHandler P{PlayerIndex}] {message}");
    }
