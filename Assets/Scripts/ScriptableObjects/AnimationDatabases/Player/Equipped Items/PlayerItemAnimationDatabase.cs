...
public class ToolAnimations : ItemAnimationSet
{
    ...
    [Tooltip("Idle animation used for melee")]
    ...
    [Tooltip("Start using tool animation (for held tools like blowtorch)")]
    public AnimationClip startUseLoop;
    ...
    [Tooltip("Stop using tool animation (for held tools like blowtorch)")]
    public AnimationClip endUseLoop;
    ...
    public override AnimationClip GetAnimationByEnum(PlayerAnimationType animationType)
    {
        return animationType switch
        {
            ...
            PlayerAnimationType.HeldPrimaryActionEnd => melee,
            PlayerAnimationType.HeldSecondaryActionStart => startUseLoop,
            PlayerAnimationType.HeldSecondaryActionEnd => endUseLoop,
            PlayerAnimationType.HeldSecondaryActionLoop => activeLoop,
            PlayerAnimationType.ReloadAction => reload,
            _ => null
        };
    }
    ...
    public override PlayerAnimationType[] GetAvailableAnimationTypesAsEnums()
    {
        return new PlayerAnimationType[] { PlayerAnimationType.SecondaryAction, PlayerAnimationType.HeldSecondaryActionLoop, PlayerAnimationType.ReloadAction };
    }
}
