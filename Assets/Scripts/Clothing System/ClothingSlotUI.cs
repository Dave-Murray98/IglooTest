...
/// <summary>
/// REFACTORED: Enhanced clothing slot UI that properly reads from ItemInstance.
/// Now displays accurate instance-specific condition and integrates with the existing drag system.
/// Provides visual feedback without interfering with the drag handler's drop logic.
/// </summary>
public class ClothingSlotUI : MonoBehaviour, IDropHandler, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler
{
    ...
    /// <summary>
    /// REFACTORED: Refresh the slot's visual display based on current ItemInstance state.
    /// Now reads condition from ClothingInstanceData for accurate display.
    /// </summary>
    public void RefreshDisplay()
    {
        ...
        // REFACTORED: Update condition bar from ItemInstance
        UpdateConditionBar(slot);
    }

    /// <summary>
    /// REFACTORED: Update the condition bar based on ItemInstance data.
    ...
    private void UpdateConditionBar(ClothingSlot slot)
    {
        ...
        if (!isEmpty)
        {
            ...
            {
                // REFACTORED: Get condition percentage from instance data
                float conditionPercentage = instanceData.GetConditionPercentage(templateData);
    ...
    /// <summary>
    /// REFACTORED: Drop handler with comprehensive validation and rejection feedback.
    ...
    public void OnDrop(PointerEventData eventData)
    {
        ...
        // REFACTORED: Comprehensive validation with detailed rejection handling
        ...
        {
            // REFACTORED: Detailed rejection with specific feedback
    ...
    /// <summary>
    /// REFACTORED: Comprehensive validation for clothing drops with detailed error messages.
    /// </summary>
    ...
    /// <summary>
    /// Get user-friendly text for valid clothing layers.
    /// </summary>
    ...
    /// <summary>
    /// Static method to detect when inventory items are being dragged over clothing slots.
    ...
    /// <summary>
    /// Static method to clear drag feedback from all clothing slots.
    /// </summary>
    ...
    /// <summary>
    /// REFACTORED: Handle condition changes for equipped items.
    /// Now properly updates UI when ItemInstance condition changes.
    /// </summary>
