...
/// </summary>
public class DoorToOtherLevelInteractable : InteractableBase, IConditionalInteractable
{
    [Header("Door Settings")]
    [SerializeField] private DoorwayToOtherLevel doorwayComponent;
    ...
    protected override void Awake()
    {
        ...
        {
            doorwayComponent = GetComponent<DoorwayToOtherLevel>();
        }
