...
/// </summary>
public class OldGunnerInputHandler : MonoBehaviour
{
    [Header("Debug")]
    ...
    private void Awake()
    {
        ...
        if (playerInput == null)
        {
            Debug.LogError("[OldGunnerInputHandler] No PlayerInput component found!");
            return;
        }
    ...
    private void SetupInputActions()
    {
        ...
        if (gunnerMap == null)
        {
            Debug.LogError("[OldGunnerInputHandler] Gunner action map not found!");
            return;
        }
    ...
    {
        if (enableDebugLogs)
            Debug.Log($"[OldGunnerInputHandler P{PlayerIndex} G{GunnerNumber + 1}] {message}");
    }
