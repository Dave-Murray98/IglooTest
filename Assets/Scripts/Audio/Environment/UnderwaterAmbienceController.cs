...
public class UnderwaterAmbienceController : MonoBehaviour
{
    ...
    private SubmarineHealthManager healthManager;
    ...
    private void FindPlayerReferences()
    {
        ...
        DebugLog($"References found - WaterDetector: {waterDetector != null}, healthManager: {healthManager != null}, Camera: {playerCamera != null}, AudioListener: {audioListener != null}");
    }
    ...
    private AmbienceState DetermineTargetState()
    {
        ...
        if (!isHeadSubmerged || currentWaterDepth < headSubmersionThreshold)
        {
