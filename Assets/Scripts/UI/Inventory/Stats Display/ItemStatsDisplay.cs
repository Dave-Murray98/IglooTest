...
public class ItemStatsDisplay : MonoBehaviour
{
    ...
    /// </summary>
    public void DisplayItemStats(InventoryItemData inventoryItemData)
    {
        ...
        currentDisplayedItem = inventoryItemData;

        // Update item name
        if (itemNameText != null)
        {
            itemNameText.text = inventoryItemData.ItemData.itemName;
            itemNameText.color = GetItemNameColor(inventoryItemData.ItemData);
        }

        // Update item description
        if (itemDescriptionText != null)
        {
            itemDescriptionText.text = inventoryItemData.ItemData.description;
        }

        // Update item icon
        if (itemIconImage != null)
        {
            itemIconImage.sprite = inventoryItemData.ItemData.itemSprite;
            itemIconImage.gameObject.SetActive(inventoryItemData.ItemData.itemSprite != null);
        }

        // Update item stats
        if (itemStatsText != null)
        {
            itemStatsText.text = ItemStatsFormatter.FormatItemStats(inventoryItemData.ItemInstance);
        }
        ...
        // Fire event
        OnItemDisplayed?.Invoke(inventoryItemData);
