...
public class PlayerPersistenceManager : MonoBehaviour
{
    ...
    /// IMPROVED: Excludes audio-related components to allow manual restoration order
    /// </summary>
    public void RestoreFromSaveFile(Dictionary<string, object> saveData)
    {
        ...
        DebugLog("Save file player data restoration complete (audio components excluded)");
    }
